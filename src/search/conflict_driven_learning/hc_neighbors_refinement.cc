...
bool HCNeighborsRefinement::learn_from_dead_end_component(
...
bool HCNeighborsRefinement::requires_recognized_neighbors() const
{
    return true;
}
...
static PluginShared<conflict_driven_learning::ConflictLearner> _plugin("hcrn", _parse);
